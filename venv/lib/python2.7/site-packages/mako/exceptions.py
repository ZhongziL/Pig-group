...
class RichTraceback(object):
    ...
    Mako-specific templates information.
    ...
    def traceback(self):
        ...
        format) with templates-corresponding lines remapped to the originating
        templates.
    ...
    def _init(self, trcback):
        ...
        templates filename, the line number adjusted relative to the templates
        source, and code line from that line number of the templates."""
...
def text_error_template(lookup=None):
    """Provides a templates that renders a stack trace in a similar format to
    the Python interpreter, substituting source templates filenames, line
    numbers and code for that of the originating source templates, as
    applicable.
...
def html_error_template():
    """Provides a templates that renders a stack trace in an HTML format,
    providing an excerpt of code as well as substituting source templates
    filenames, line numbers and code for that of the originating source
    templates, as applicable.

    The templates's default ``encoding_errors`` value is
    ``'htmlentityreplace'``. The templates has two options. With the
