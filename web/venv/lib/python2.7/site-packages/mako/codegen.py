...
# templates and are not accessed via the
# context itself
...
class _GenerateRenderMethod(object):
    ...
    """A templates visitor object which generates the
       full module source for a templates.
    ...
    def write_toplevel(self):
        """Traverse a templates structure for module-level directives and
        ...
        if self.compiler.imports:
            ...
            impcode = ast.PythonCode(
                ...
                source='', lineno=0,
                pos=0,
                filename='templates defined imports')
        else:
            impcode = None
    ...
    def write_module_code(self, module_code):
        """write module-level templates code, i.e. that which
        is enclosed in <%! %> tags in the templates."""
        for n in module_code:
    ...
    def write_inherit(self, node):
        ...
        self.printer.writelines(
            "def _mako_inherit(templates, context):",
    ...
    def visitCode(self, node):
        if not node.ismodule:
            ...
            if not self.in_def and len(self.identifiers.locally_assigned) > 0:
                # if we are the "templates" def, fudge locally
                # declared/modified variables into the "__M_locals" dictionary,
                # which is used for def calls within the same templates,
...
class _Identifiers(object):
    ...
    """tracks the status of identifier names as templates code is rendered."""
    ...
    def __init__(self, compiler, node=None, parent=None, nested=False):
        ...
        if illegal_names:
            raise exceptions.NameConflictError(
                "Reserved words declared in templates: %s" %
                ", ".join(illegal_names))
