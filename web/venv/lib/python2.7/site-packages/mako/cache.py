...
class Cache(object):
    ...
    for data specific to this templates.
    ...
    is recompiled, such as when the original templates file changed on
    the filesystem.

    """

    def __init__(self, template, *args):
        # check for a stale templates calling the
        # constructor
    ...
    def invalidate_closure(self, name):
        """Invalidate a nested ``<%def>`` within this templates.

        Caching of nested defs is a blunt tool as there is no
        management of scope -- nested defs that use cache tags
        need to have names unique of all other nested defs in the
        templates, else their content will be overwritten by
        each other.
