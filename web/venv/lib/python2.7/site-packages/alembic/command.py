...
def list_templates(config):
    ...
    config.print_stdout("\n  alembic init --templates generic ./scripts")
...
def init(config, directory, template='generic'):
    ...
    :param template: string name of the migration environment templates to
     use.
    ...
    if not os.access(template_dir, os.F_OK):
        raise util.CommandError("No such templates %r" % template)
