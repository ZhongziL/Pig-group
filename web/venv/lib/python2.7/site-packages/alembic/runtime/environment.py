...
class EnvironmentContext(util.ModuleClsProxy):
    ...
    def configure(self,
        ...
        :param template_args: dictionary of templates arguments which
         will be added to the templates argument environment when
        ...
        :param upgrade_token: When autogenerate completes, the text of the
         candidate upgrade operations will be present in this templates
         variable when ``script.py.mako`` is rendered.  Defaults to
         ``upgrades``.
        :param downgrade_token: When autogenerate completes, the text of the
         candidate downgrade operations will be present in this
         templates variable when ``script.py.mako`` is rendered.  Defaults to
         ``downgrades``.
